...
This document defines the ordered progression of capability delivery.
It translates milestone definitions into execution sequence and focus.

Milestones define capability boundaries.
This roadmap defines progression and current focus.
...
Objective:
Create the repository and establish governance infrastructure.
...
Objective:
Establish working technical foundation.
...
Deliverable:
Application boots locally with empty schema.
...
Objective:
Introduce MenuVersion workspace model.
...
Deliverable:
Draft workspace retrievable via domain.
...
Objective:
Enable category management with strict ordering.
...
Objective:
Enable item management within categories.
...
Objective:
Enable safe publish and public consumption.
...
Current Phase:
Pre-repository governance completion.

Next Action:
Draft Phase 1 and Milestone 0 issues before repository creation.

---

# Initial Issue Draft (Pre-Repository Planning)

The following issues will be created once the repository exists.
These represent the first executable wave of work.
...
Type: Documentation
Milestone: Phase 1 — Repository Initialization

**Problem**
Repository must contain all authoritative governance and architecture documents before technical work begins.
...
**Problem**
`main` must be protected to enforce disciplined workflow.
...
**Problem**
Standardized issue and PR structure is required for consistency.
...
**Problem**
Issues must be classifiable and trackable by milestone.
...
**Problem**
Project requires a working application skeleton before domain work begins.
...
**Problem**
Strict typing and linting are required for architectural discipline.
...
**Problem**
Persistence layer must be initialized before domain modeling.
...
**Problem**
Migration pipeline must be verified early.
...
**Problem**
Project must be reproducible from clean clone.
...
Exit Condition for Issue Wave:
All Milestone 0 issues closed and application boots locally from clean clone.
